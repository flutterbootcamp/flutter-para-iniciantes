...
Quando criamos um Stateless widget, o Flutter executa o seu construtor e sem seguida o método [build\(\)](https://api.flutter.dev/flutter/widgets/StatelessWidget/build.html). 
